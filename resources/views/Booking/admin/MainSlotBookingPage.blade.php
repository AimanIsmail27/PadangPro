...
<div class="container mx-auto px-4 pb-12">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center">
        <div>
            ...
            <p class="text-gray-500 mt-1">Select a time slot to book for your client.</p>
        </div>
    </div>
...
<div id="landscapeHint" class="fixed bottom-0 left-0 right-0 p-3 z-50 shadow-2xl bg-indigo-600/95 backdrop-blur-sm">
