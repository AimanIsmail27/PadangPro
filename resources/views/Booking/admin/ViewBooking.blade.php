...
<div class="bg-white rounded-xl shadow-md border border-gray-100 p-6 md:p-8 w-11/12 mx-auto -mt-16 relative space-y-12">

    <div class="bg-gray-50 p-4 rounded-lg border">
        <form action="{{ route('admin.booking.viewAll') }}" method="GET" class="flex items-center space-x-4">
...
@push('scripts')
{{-- Include SweetAlert2 library only once --}}
