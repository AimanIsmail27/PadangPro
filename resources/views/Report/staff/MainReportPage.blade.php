...
@section('title', 'Reports Dashboard - PadangPro Staff')
...
<div class="bg-gradient-to-r from-lime-500 to-emerald-600 text-white pt-8 pb-32 px-10 rounded-lg shadow-2xl">
    <h1 class="text-3xl font-bold">Reports Dashboard</h1>
    <p class="mt-2 text-lime-100">Review sales, bookings, and AI-powered forecasts.</p>
</div>
...
<div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 md:p-8 w-11/12 mx-auto -mt-24 relative space-y-12">
    ...
    <div>
        <div class="flex flex-wrap justify-between items-center gap-4 mb-4">
            ...
            <a href="{{ route('staff.reports.create') }}" class="bg-lime-600 hover:bg-lime-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition transform hover:scale-105">
                Generate New Report
            </a>
        </div>
    ...
    <div class="pt-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">
            <i class="bi bi-robot text-lime-600"></i> AI Generated: Next 7-Day Booking Demand Forecast
        </h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 bg-gray-50 p-6 rounded-lg border">
                ...
                <div id="forecast-recommendation" class="text-sm text-gray-700 bg-lime-50 border border-lime-200 p-3 rounded-md">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // --- SCRIPT FOR BOOKING REVENUE CHART (Original Colors) ---
        ...
        // --- SCRIPT FOR TOP RENTED ITEMS CHART (Original Colors) ---
        ...
        // ===============================================
        // SCRIPT FOR AI FORECAST (Uses Staff Route)
        // ===============================================
        const ctxForecast = document.getElementById('forecastChart').getContext('2d');
        
        fetch('{{ route("staff.reports.forecast") }}') // <-- UPDATED ROUTE
            .then(response => {
                if (!response.ok) { throw new Error('Network response was not ok'); }
                return response.json();
            })
            .then(data => {
                // Draw the chart (Original Colors)
            ...
            .catch(error => {
                ...
                const chartContext = ctxForecast.getContext('2d');
                chartContext.font = "16px Arial";
                chartContext.fillStyle = "red";
                chartContext.textAlign = "center";
                chartContext.fillText("Forecast data unavailable.", ctxForecast.canvas.width / 2, ctxForecast.canvas.height / 2);
            });
    });
</script>
@endpush