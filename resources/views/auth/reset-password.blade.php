    ...
    <div class="w-full md:w-1/2 h-80 md:h-auto combo-gradient text-white relative
        ...
        <div class="relative z-10 p-8 md:p-12 h-full flex flex-col">
            ...
            <p class="mt-4 text-white/80 max-w-md leading-relaxed hidden md:block stagger-2">
                Set a new password for your account. Choose something strong and easy for you to remember.
            </p>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <span onclick="toggleField('newPassword')"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <span onclick="toggleField('confirmPassword')"
                              class="absolute right-3 top-3.5 cursor-pointer text-gray-400 hover:text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <p class="text-center text-base mt-3 text-gray-600">
                    Done here? <a href="{{ route('login') }}" class="text-blue-600 hover:underline font-semibold">Back to Login</a>
                </p>
            </form>
        </div>
