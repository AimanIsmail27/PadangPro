...
<head>
    ...
    <title>Forgot Password - PadangPro</title>
    ...
    <style>
        ...
        /* ✅ Animations (same behaviour as login page) */
...
<body class="min-h-screen flex flex-col md:flex-row bg-gray-50 md:bg-white">
    ...
    <!-- LEFT PANEL (matches login design) -->
    <div class="w-full md:w-1/2 h-80 md:h-auto combo-gradient text-white relative
        ...
        <div class="relative z-10 p-8 md:p-12 h-full flex flex-col">
            ...
            <p class="mt-4 text-white/80 max-w-md leading-relaxed hidden md:block stagger-2">
                Forgot your password? No worries — we’ll send a reset link to your email so you can get back in fast.
            </p>
            ...
            <div class="md:hidden flex flex-col justify-center h-full text-center stagger-2">
                <p class="text-2xl font-bold italic opacity-90">Forgot Password?</p>
                <p class="text-green-200 text-sm mt-2">No worries — we’ll help you get back in.</p>
            </div>
        </div>
    </div>

    <!-- RIGHT PANEL (matches login card + overlap behaviour) -->
    <div class="w-full md:w-1/2 flex justify-center items-start md:items-center
        ...
        <div class="w-full max-w-md p-8 bg-white rounded-3xl shadow-xl border border-slate-100 anim-card">
            ...
            <h2 class="text-2xl md:text-3xl font-semibold mb-2 text-gray-800">Reset Password</h2>
            ...
            <form action="{{ route('password.email') }}" method="POST" class="space-y-5">
                ...
                <!-- Keep button style consistent with login page -->
                <button type="submit"
