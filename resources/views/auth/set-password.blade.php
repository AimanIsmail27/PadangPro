...
<body class="min-h-screen flex flex-col md:flex-row bg-gray-50 md:bg-white">
    ...
    <div class="w-full md:w-1/2 h-80 md:h-auto combo-gradient text-white flex flex-col relative p-8 md:p-10 justify-start shadow-xl md:shadow-none rounded-b-[3rem] md:rounded-none z-0">
        ...
        <div class="hidden md:block absolute bottom-10 left-10 font-bold italic text-[90px] leading-tight" style="font-family: 'Poppins', sans-serif;">
            Reserve.<br>
            Play.<br>
            Repeat.
        </div>
    ...
    <div class="w-full md:w-1/2 flex justify-center items-start md:items-center -mt-24 md:mt-0 px-4 md:px-0 relative z-10">
        ...
        <div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-2xl md:shadow-none md:rounded-none">
            ...
            <form action="{{ route('google.password.save') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-lg font-medium mb-1 text-gray-700">
                        New Password
                    </label>
